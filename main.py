...
parser.add_argument('--threshold', type = float, default = None, metavar = 'Th', help='Threshold for ternary weight')
...
parser.add_argument('--momentum', type = float, default = 0.9, metavar = 'mntm', help='Momentum for sgd')
